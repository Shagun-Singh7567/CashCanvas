# CashCanvas
## Overview
CashCanvas is a simple budget tracker CLI app which helps users store and view transactions and income in csv files, and view their spending habits as a 
...
Monthly & Weekly Summaries – See spending patterns as .
...
![Bar Graph - Terminal View](/assets/BarGraph-Terminal.png)
![Bar Graph](/assets/BarGraph-Visual.png)
![Pie Chart - Terminal View](/assets/PieChart-Terminal.png)
![Pie Chart](/assets/PieChart-Visual.png)
![Line Plot - Terminal View](/assets/LinePlot-Terminal.png)
