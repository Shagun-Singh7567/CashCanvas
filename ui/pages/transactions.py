...
class TransactionsPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        # Main area (history and form swap here)
    ...
    def _build_form(self):
        ...
        self.amt_entry  = form_field(fields, "AMOUNT (₹)", "e.g. 500")
        ...
        self.cat_entry  = form_field(fields, "CATEGORY",
                                     widget_type="option", options=CATEGORIES)
    ...
    def _refresh(self):
        ...
        for r in read_csv(TX_FILE):
            try:
                self.tv.insert("", "end",
                               values=(f"−₹{float(r[0]):,.0f}", r[1], r[2], r[3]))
            except Exception:
                pass
